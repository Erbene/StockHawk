...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
                            ...
                            .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                                @Override public void onInput(MaterialDialog dialog, CharSequence input) {
                                    ...
                                    if (c.getCount() != 0) {
                                        Toast toast =
                                                Toast.makeText(MyStocksActivity.this, getResources().getString(R.string.already_in_db),
                                                        Toast.LENGTH_LONG);
        ...
        mEventReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if(intent.getAction().equals(StockTaskService.INVALID_INPUT)) {
                    Toast.makeText(getApplicationContext(), getResources().getString(R.string.invalid_input),
                            Toast.LENGTH_SHORT).show();
                } else if(intent.getAction().equals(StockTaskService.SERVER_UNAVAILABLE)){
                    Toast.makeText(getApplicationContext(), getResources().getString(R.string.server_unavailable),
                            Toast.LENGTH_SHORT).show();
                }
            }
        };
    ...
    public void onResume() {
        ...
        intentFilter.addAction(StockTaskService.INVALID_INPUT);
        intentFilter.addAction(StockTaskService.SERVER_UNAVAILABLE);
